...
public class XLSBSheetHandler implements XSSFSheetXMLHandler.SheetContentsHandler {
	...
	public void cell(String cellReference, String formattedValue, XSSFComment comment) {
	    ...
	    if (comment == null) {
	    	...
	    	/***********************************************************************************************************************/
	    	/*if (formattedValue.equals(AssetUpload.contractID)) {
	            //System.out.println("**^^** ID=" + AssetUpload.contractID + "-- FV=" + formattedValue + "--");
